...
Still to capture: a bound trip (item 4) and a queue-cap rejection (item 5), both from M5. The empty week is now covered by `m2-quiet-week.txt`, though it still does not
